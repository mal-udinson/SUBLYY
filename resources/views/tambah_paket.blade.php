...
<head>
    ...
    <title>SUBLY | Tambah Paket Layanan</title>
...
<body>
    ...
    <div class="card card-form shadow-lg p-4">
        <h3 class="fw-bold text-white mb-1">Tambah Paket Pilihan</h3>
        <p class="text-secondary small mb-4">Layanan: <span class="text-info fw-semibold">{{ $layanan->nama_layanan }}</span></p>
        ...
        <form action="/paket/simpan" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="nama_paket" class="form-control py-2" placeholder="Contoh: 1 Bulan Premium Ultra HD" required>
            </div>
            ...
            <div class="mb-4">
                ...
                <textarea name="deskripsi" class="form-control" rows="4" style="background-color: #334155; color: #fff; border: 1px solid #475569; resize: none;" placeholder=""></textarea>
            </div>
